...
##synchronized 关键字
synchronized关键字是用来控制线程同步的，就是在多线程的环境下，控制synchronized代码段不被多个线程同时执行。是一种阻

塞性的锁,synchronized既可以加在一段代码上，也可以加在方法上。synchronized(this)及非static的synchronized方法，
